...
linkStyle('https://aslclientshowdown-production.up.railway.app/style/font-awesome.css?');
linkStyle('https://aslclientshowdown-production.up.railway.app/style/battle.css?a7');
linkStyle('https://aslclientshowdown-production.up.railway.app/style/replay.css?a7');
linkStyle('https://aslclientshowdown-production.up.railway.app/style/utilichart.css?a7');

requireScript('https://aslclientshowdown-production.up.railway.app/js/lib/ps-polyfill.js');
requireScript('https://aslclientshowdown-production.up.railway.app/config/config.js?a7');
requireScript('https://aslclientshowdown-production.up.railway.app/js/lib/jquery-1.11.0.min.js');
requireScript('https://aslclientshowdown-production.up.railway.app/js/lib/html-sanitizer-minified.js');
requireScript('https://aslclientshowdown-production.up.railway.app/js/battle-sound.js');
requireScript('https://aslclientshowdown-production.up.railway.app/js/battledata.js?a7');
requireScript('https://aslclientshowdown-production.up.railway.app/data/pokedex-mini.js?a7');
requireScript('https://aslclientshowdown-production.up.railway.app/data/pokedex-mini-bw.js?a7');
requireScript('https://aslclientshowdown-production.up.railway.app/data/graphics.js?a7');
requireScript('https://aslclientshowdown-production.up.railway.app/data/pokedex.js?a7');
requireScript('https://aslclientshowdown-production.up.railway.app/data/moves.js?a7');
requireScript('https://aslclientshowdown-production.up.railway.app/data/abilities.js?a7');
requireScript('https://aslclientshowdown-production.up.railway.app/data/items.js?a7');
requireScript('https://aslclientshowdown-production.up.railway.app/data/teambuilder-tables.js?a7');
requireScript('https://aslclientshowdown-production.up.railway.app/js/battle-tooltips.js?a7');
requireScript('https://aslclientshowdown-production.up.railway.app/js/battle.js?a7');
