...
<html lang="en"><head>
	...
	<main>
		<h1>
			Index of
			<a href="/">play.pokemonshowdown.com</a><wbr />/<a href="/sprites/">sprites</a><wbr />/trainers/
		</h1>
	...
	<div>
		...
		<ul class="nav" style="display:inline-block;vertical-align:middle;margin:0">
			...
			<li><a class="button" href="./?view=sprites&filter=recent">Recent</a></li>
			<li><a class="button nav-last" href="./?view=sprites&filter=credited">Credited</a></li>
		</ul>
	</div>
</main>
<figure id="aaron.png">
